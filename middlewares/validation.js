const { loginSchema, signUpSchema,employeeSchema } = require("../models/schemas");
...
module.exports = {signUpValidationMiddleware,loginValidationMiddleware,employeeValidationMiddleware };
